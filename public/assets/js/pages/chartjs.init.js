    ...
    (r.prototype.respChart = function (r, o, e, t) {
        ...
        (r.prototype.init = function () {
            ...
            o &&
                ...
                this.respChart(p("#lineChart"), "Line", r, { scales: { yAxes: [{ ticks: { max: 100, min: 20, stepSize: 10 } }] } }));
            var e,
            ...
            i &&
                ((l = {
                    ...
                    datasets: [{ label: "Sales Analytics", backgroundColor: i[0], borderColor: i[0], borderWidth: 1, hoverBackgroundColor: i[1], hoverBorderColor: i[1], data: [65, 59, 81, 45, 56, 80, 50, 20] }],
                }),
                this.respChart(p("#bar"), "Bar", l, { scales: { xAxes: [{ barPercentage: 0.4 }] } }));
            var d,
            ...
            C &&
                ((u = { datasets: [{ data: [11, 16, 7, 18], backgroundColor: C, label: "My dataset", hoverBorderColor: "#fff" }], labels: ["Series 1", "Series 2", "Series 3", "Series 4"] }), this.respChart(p("#polarArea"), "PolarArea", u));
        }),
        (p.ChartJs = new r()),
