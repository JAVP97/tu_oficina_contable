<nav class="navbar navbar-light navbar-expand-lg topnav-menu">
    ...
    <div class="collapse navbar-collapse" id="topnav-menu-content">
        <ul class="navbar-nav">
            ...
            <li class="nav-item  {{ request()->is('inicio') ? 'mm-active' : '' }}">
                <a class="nav-link  waves-effect {{ request()->is('inicio') ? 'active' : '' }}" href="{{ route('inicio') }}" >
                    <i class="bx bx-home-circle"></i>
                    <span key="t-starter-page">Inicio</span>
                </a>
            </li>
            <li class="nav-item  {{ request()->is('clientes') ? 'mm-active' : '' }}">
                <a class="nav-link  waves-effect {{ request()->is('clientes') ? 'active' : '' }}" href="{{ route('clientes.index') }}" >
            ...
            <li class="nav-item dropdown">
                ...
                >
                    <i class="bx bx-cog"></i>
                    <span key="t-ui-elements"> Administración</span> 
