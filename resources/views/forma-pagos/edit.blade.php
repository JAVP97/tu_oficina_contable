    ...
    <div class="col-md-12 col-12">
        <div class="card col-12 col-md-6">
            <div class="card-body">
                ...
                <form action="{{route('forma-pago.update', $formaPago->id)}}" method="post" id="form" class="row gy-2 gx-3 align-items-center">
                    @method('PUT')
                    @csrf
                    <div class="col-sm-auto">
                        <label class="visually" for="nombre_fp">Nombre forma de pago</label>
                        <input type="text" class="form-control" id="nombre_fp" name="nombre_fp" value="{{$formaPago->nombre_fp}}" required>
                    </div>

                    <div class="col-sm-auto">
                        <button type="submit" class="btn btn-primary w-md mt-4" id="send">Actualizar</button>
                    </div>
                </form>
            </div>
        </div>
